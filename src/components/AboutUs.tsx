...
const FEATURES = [
  {
    ...
    description:
      "Browse the latest headlines and stories from trusted sources in Tamil, English, Hindi, and more.",
    audioOnly: false,
  },
  {
    icon: Rss,
    ...
    description: AUDIO_NEWS_ENABLED
      ...
      : "Real-time news updates from trusted sources as events happen, without delays.",
    audioOnly: false,
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    description:
      "Quick loading, low data usage, and smooth performance even on slow networks.",
    audioOnly: false,
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            {AUDIO_NEWS_ENABLED
              ? "NewsOn is built for people who want to stay informed without slowing down. We transform real-time news into high-quality audio — so you can listen anytime, anywhere."
              : "NewsOn is built for people who want to stay informed without slowing down. We bring you real-time headlines and stories from trusted sources — in your language, on any device."}
          </p>
        </motion.div>
        ...
        >
          <p className="text-xl font-medium">
            {AUDIO_NEWS_ENABLED
              ...
              : "📰 One tap. Your language. Smarter news consumption."}
          </p>
